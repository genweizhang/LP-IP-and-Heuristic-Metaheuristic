...
param jppc=20;
param pppc=25;
# total tomato and average price
param total=3000000;
param average=0.06;
# additional tomato and price
param add=600000;
param addpr=0.085;
...
s.t. limitA: Wa+Ja+Pa<=600000+add;
s.t. limitB: Wb+Jb+Pb<=2400000;
s.t. ratingW: Wa-3*Wb>=0;
s.t. ratingJ: 3*Ja-Jb>=0;

# objective function.
maximize profit: (Wa+Wb)/wppc*profw+(Ja+Jb)/jppc*profj+(Pa+Pb)/pppc*profp-total*average-add*addpr;
 
solve;
# show the results of production mix

display Wa, Wb, Ja, Jb, Pa, Pb, limitA;
