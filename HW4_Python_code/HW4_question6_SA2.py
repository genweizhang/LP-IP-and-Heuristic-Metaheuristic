...
while done == 0:
    ...
    while j < 100*math.exp(-temp/40):        # temperature affects iterations #, less iterations at high temp and more iterations at low temp!         
        s = Neighborhood[j]                   #evaluate  members in the neighborhood of x_curr
    ...
    temp = inittemp*math.pow(alpha, solutionsChecked/1000)           # anneal the temperature using exponential schedule
