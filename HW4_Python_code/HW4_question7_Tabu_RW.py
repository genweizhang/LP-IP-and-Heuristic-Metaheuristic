...
# neighborhood structures of solution x         
def neighborhood(x):
    # one-flip     
    nbrhood1 = []     
    for i in range(0,n):
...
## random walk
prob=0.05 # random walk probability
...
while done == 0:
    ...
    if f_best == f_curr and f_best[0]!= 0:               #if there were no improving solutions in the neighborhood
        done = 1
    else: 
